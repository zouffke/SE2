Feature: Een subrecept toevoegen aan een recept
    ...
    Scenario: Subrecept toevoegen aan recept
        ...
        And heeft het recept 3 bereidingsstappen
        And de bereidingstap 1 voor recept 1 heeft beschrijving "Doe de kaas in de pan"
        And de bereidingstap 2 voor recept 1 heeft beschrijving "Maak de bechamelsaus, zoek online op"
        And de bereidingstap 3 voor recept 1 heeft beschrijving "Zet de kaas op een zacht vuurtje gedurende 5 minuten"
